...
function Header() {
  ...
  return (
    <div className="header w-full h-14 bg-white drop-shadow-sm">
      ...
      <div className="flex h-full justify-end items-center">
        ...
        <div className="relative inline-block z-0">
          ...
          <ul className="z-10 hidden absolute w-24 right-1 px-4 py-2
          bg-white shadow-2xl rounded text-md text-slate-400
          peer-hover:block hover:block">
            <li className="hover:text-bg-nav"><a href="#a">Profile</a></li>
            <li className="hover:text-bg-nav"><a href="#a">Setting</a></li>
            <li className="text-red-500 border-t border-gray-300
            hover:text-bg-nav"><a href="#logout" onClick={handleLogout}>Log out</a></li>
          </ul>
        </div>
      </div>
    </div>
